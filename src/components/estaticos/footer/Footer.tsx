      ...
      >
        <Grid className="footer-box">
          ...
          <Box>
            <Box>
              <Typography variant="h6" className="footer-title">
                Receba ofertas exclusivas e muita dica sobre alimentação saudável. Assine nossa Newsletter!
              </Typography>
          ...
          <Box>
            ...
            <Typography variant="h6" className="footer-title">
              ...
              <Link to="/cadastrousuario" className="text-decorator-none footer">
              <Typography variant="body1" className="footer-text">
                <AssignmentIndIcon className="footer-icon1" /> Ser uma produtora parceira
              </Typography>
              </Link>
            </Box>
            <Box>
        ...
        <Grid alignItems="center" item xs={12}>
          <Box className="footer-copyright">
            <Typography variant="subtitle2" className="copy" align="center">
              © Copyright 2022 Ceuci
            </Typography>
          </Box>
        </Grid>
      </Grid>
