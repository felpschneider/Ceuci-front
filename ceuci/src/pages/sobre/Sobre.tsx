          ...
          <Grid>
            <Box>
              ...
              <p className="texto">
                ...
                Numquam dicta aperiam asperiores quae in ipsam animi nihil eius
                blanditiis nam quibusdam dolore soluta, rerum placeat atque
                recusandae a quidem eveniet.
              </p>
            </Box>
          </Grid>
          ...
          <Grid direction="row" alignItems="center">
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/leaoquara" target="_blank" rel="noreferrer">
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/thabatadepaula" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/felpschneider" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/milhoratti" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/TamiresSss" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/beatrizramoss" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box className="social">
                ...
                <a href="https://github.com/Kamilla-Rocha" target="_blank" rel="noreferrer">
                  <GitHub style={{ fontSize: 40, color: "#000000" }} />
                </a>
